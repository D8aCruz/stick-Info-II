...
//!< ----------- Estados de PINSEL:
	#define	 	    PINSEL_GPIO			0	   // el de defecto
	...
	//0x4002C068UL : Direccion de inicio de los registros de modo de los pines del GPIO
	#define		PINMODE_OD	( ( uint32_t  * ) 0x4002C068UL )
	//Registros PINMODE_OD
	#define		PINMODE_OD0		PINMODE[0]
	#define		PINMODE_OD1		PINMODE[1]
	#define		PINMODE_OD2		PINMODE[2]
	#define		PINMODE_OD3		PINMODE[3]
	#define		PINMODE_OD4		PINMODE[4]
